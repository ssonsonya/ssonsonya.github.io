! function() {
    ...
    function b() {
        if (!m && document.body) {
            ...
            var e = document.body,
                ...
                n = e.scrollHeight;
            if (f = 0 <= document.compatMode.indexOf("CSS") ? t : e, u = e, p.keyboardSupport && Y("keydown", D), top != self) d = !0;
            else if (Z && o < n && (e.offsetHeight <= o || t.offsetHeight <= o)) {
                var r, a = document.createElement("div");
                a.style.cssText = "position:absolute; z-index:-10000; top:0; left:0; right:0; height:" + f.scrollHeight + "px", document.body.appendChild(a), c = function() {
                    r || (r = setTimeout(function() {
                        s || (a.style.height = "0", a.style.height = f.scrollHeight + "px", r = null)
                    }, 500))
            ...
            p.fixedBackground || s || (e.style.backgroundAttachment = "scroll", t.style.backgroundAttachment = "scroll")
        }
    }
    var g = [],
        S = !1,
    ...
    function k(d, m, f) {
        var e, t;
        if (e = 0 < (e = m) ? 1 : -1, t = 0 < (t = f) ? 1 : -1, (l.x !== e || l.y !== t) && (l.x = e, l.y = t, g = [], x = 0), 1 != p.accelerationMax) {
            var o = Date.now() - x;
            ...
            var w = function(e) {
                for (var t = Date.now(), o = 0, n = 0, r = 0; r < g.length; r++) {
                    ...
                    var u = a.x * c - a.lastX >> 0,
                        s = a.y * c - a.lastY >> 0;
                    o += u, n += s, a.lastX += u, a.lastY += s, i && (g.splice(r, 1), r--)
                }
                h ? window.scrollBy(o, n) : (o && (d.scrollLeft += o), n && (d.scrollTop += n)), m || f || (g = []), g.length ? R(w, d, 1e3 / p.frameRate + 1) : (S = !1, null != d.$scrollBehavior && (d.style.scrollBehavior = d.$scrollBehavior, d.$scrollBehavior = null))
            };
            R(w, d, 0), S = !0
        }
    }
    ...
    function e(e) {
        ...
        if (N(u, "embed") || N(t, "embed") && /\.pdf/i.test(t.src) || N(u, "object") || t.shadowRoot) return !0;
        ...
        return r ? !! function(e) {
            ...
            var t = 120 < e && $(e);
            return !$(120) && !$(100) && !t
        }(n) || (1.2 < Math.abs(o) && (o *= p.stepSize / 120), 1.2 < Math.abs(n) && (n *= p.stepSize / 120), k(r, o, n), e.preventDefault(), void C()) : !d || !U || (Object.defineProperty(e, "target", {
    ...
    var P, R = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(e, t, o) {
        ...
        q = (P = document.scrollingElement, function() {
            if (!P) {
    ...
    var I, _ = window.navigator.userAgent,
        W = /Edge/.test(_),
        U = /chrome/i.test(_) && !W,
        G = /safari/i.test(_) && !W,
        J = /mobile/i.test(_),
    ...
    "onwheel" in document.createElement("div") ? I = "wheel" : "onmousewheel" in document.createElement("div") && (I = "mousewheel"), I && ee && (Y(I, e), Y("mousedown", t), Y("load", b)), te.destroy = function() {
        i && i.disconnect(), A(I, e), A("mousedown", t), A("keydown", D), A("resize", c), A("load", b)
    }, window.SmoothScrollOptions && te(window.SmoothScrollOptions), "function" == typeof define && define.amd ? define(function() {
        return te
