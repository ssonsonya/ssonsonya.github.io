...
> + GetComponentSpaceTransform 함수 위치 : \Engine\Source\Runtime\Engine\private\Animation\PoseAsset.cpp
...
상위 본노드에 대한 상대적 트랜스폼을 병합(Compose)시켜주면서 Foot본을 최상위본인 Root로부터의 상대적 트랜스폼을 계산해주는 방식으로 본의 Component스페이스 기준 Transform을 구할 수 있다  
